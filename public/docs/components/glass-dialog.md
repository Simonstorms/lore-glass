...
```bash
npx shadcn@latest add https://loreglasses.com/r/glass-dialog.json
# or, with the @lore-glass namespace registered:
npx shadcn@latest add @lore-glass/glass-dialog
```
...
| Prop | Type | Default | Description |
| --- | --- | --- | --- |
| `tint` | `number` | `0.75` | Glass tint of the panel. Dialogs default high for legibility over arbitrary pages. |
